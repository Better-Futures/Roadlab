...
export const IconContainer = styled.span`
    ...
    padding: 5px 10px;
    border-radius: 5px; 
    background: linear-gradient(141.17deg, #272727 0%, #11101d 100%);
...
export const CTAContainer= styled.div`
    border-radius: 5px; 
    background: linear-gradient(-163.39deg, #272727 0%, #11101d 100%);
    box-shadow: 0px 20px 100px -10px rgba(66, 71, 91, 0.1);
    width: 80%;
    height: 100%;
    padding: 20px;
...
export const Testimon = styled.div`
    border-radius: 5px; 
    background: linear-gradient(141.39deg, #272727 0%, #11101d 100%);
    box-shadow: 0px 20px 100px -10px rgba(66, 71, 91, 0.1);
    width: 95%;
    height: 100%;
